...
### Installering:
```
npm install nav-frontend-alertstriper babel-polyfill classnames nav-frontend-alertstriper-style nav-frontend-core nav-frontend-typografi-style nav-frontend-ikoner-assets nav-frontend-paneler-style nav-frontend-typografi prop-types react --save
```
