...
### Installering:
```
npm install nav-frontend-hjelpetekst-style babel-polyfill babel-runtime classnames nav-frontend-core nav-frontend-lukknapp-style nav-frontend-typografi-style nav-frontend-lenker-style react --save
```
