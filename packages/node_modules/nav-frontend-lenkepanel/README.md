...
### Installering:
```
npm install nav-frontend-lenkepanel babel-polyfill classnames nav-frontend-lenkepanel-style nav-frontend-paneler-style nav-frontend-core nav-frontend-chevron-style react nav-frontend-typografi nav-frontend-typografi-style prop-types --save
```
